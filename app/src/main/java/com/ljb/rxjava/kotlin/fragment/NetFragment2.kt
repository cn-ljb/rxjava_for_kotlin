...
import com.ljb.rxjava.kotlin.protocol.TestProtocol2
 ...
 */
class NetFragment2 : Fragment(), View.OnClickListener {

    //懒属性，使用时初始化
    val mTestProtocol: TestProtocol2 by lazy { TestProtocol2() }
