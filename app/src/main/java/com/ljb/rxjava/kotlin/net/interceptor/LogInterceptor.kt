 ...
 */
class LogInterceptor @JvmOverloads constructor(private val logger: LogInterceptor.Logger = LogInterceptor.Logger.DEFAULT, lv: LogInterceptor.Level = LogInterceptor.Level.BODY) : Interceptor {
